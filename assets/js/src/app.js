var app = function() {
    ...
    var customCheckbox = function() {
        ...
        $('input.icheck_transparent').iCheck({
            checkboxClass: 'icheckbox_polaris',
            radioClass: 'iradio_polaris'
        });
        
        $('#property_all_check+ins').css({background:"rgba(144, 154, 160, 0.35)", opacity: 1});
        $('#property_expanded_all_check').parent().css("margin-top", "-5px");
    }
    
    var customCheckboxBySelector = function(selector) {
        $(selector+'.icheck').iCheck({
            checkboxClass: 'icheckbox_minimal',
            radioClass: 'iradio_minimal'
        });
        
        $(selector+'.icheck_transparent').iCheck({
            checkboxClass: 'icheckbox_polaris',
            radioClass: 'iradio_polaris'
        });
    }
    ...
    return {
        ...
        customCheckboxBySelector: customCheckboxBySelector,
