...
function login(){
    ...
    this.init = function(){
        utils.setPasswordShowButton($("#password"), $("#show_password_span"));
    };
        ...
        if (!this.isCredentialsEmpty()){
            ...
            $.post("/api/login/getkey.json",{
                ...
                if (response.error != undefined){
                    ...
                    if ("forbidden_already_authorized" === response.error.description){
                        $('#error_41').append('&#160;<i class="fa fa-spinner fa-spin" style="font-size:24px"></i>');
                    }
                }
                else{
                    location.href = "query";
