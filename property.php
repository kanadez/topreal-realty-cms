...
function setGlobalData($page){
    global $user, $owl, $agency, $localization, $subscription, 
            ...
            $quotes, $tools, $search_response, $responselist;
    ...
    $JSData = [
        ...
        "searchresponse_get" => isset($_GET["search"]) ? $search_response->get($_GET["search"]) : null,
        "listresponse_get" => isset($_GET["list"]) ? $responselist->get($_GET["list"]) : null
    ];
